...
from .models import PG, Room, Bed, Booking, StudentProfile, User
...
class PropertyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'address': forms.Textarea(attrs={'class': 'form-control', 'rows': 2, 'placeholder': 'Enter complete address with landmarks'}),
